...
class MindData:
    ...
    def sample_training_data(self, batch_size, num_negatives, prob=1.0):
        ...
        for impression in self.train_impressions:
            if random.random() <= prob:
                self.add_impressions(impression, user_indices, news_indices, labels, num_negatives)
    ...
    def add_impressions(self, impression, user_indices, news_indices, labels, num_negatives):
